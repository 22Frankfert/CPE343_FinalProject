      ...
      <Grid
          ...
          <FormLabel id="gender">เพศ</FormLabel>
            <RadioGroup
              ...
              onChange={(e) => setGender(e.target.value)}>
                ...
                <FormControlLabel sx={{ml:2}} value="กำลังตั้งครรภ์ หรือมีแผนในการมีลูก" control={<Radio/>} label="กำลังตั้งครรภ์ หรือมีแผนในการมีลูก" ></FormControlLabel>
                <FormControlLabel sx={{ml:2}} value="ไม่ได้กำลังตั้งครรภ์ หรือมีแผนในการมีลูก" control={<Radio/>} label="ไม่ได้กำลังตั้งครรภ์ หรือมีแผนในการมีลูก"></FormControlLabel>
          ...
          <FormLabel id="underlying_disease">มีโรคประจำตัวหรือไม่</FormLabel>
            <RadioGroup
              ...
              onChange={(e) => setUnderlying_disease(e.target.value)}>
                ...
                <FormControlLabel id="underlying_disease1"value="ภาวะพร่องเอ็นไซม์" control={<Checkbox/>} label="ภาวะพร่องเอ็นไซม์"></FormControlLabel>
                <FormControlLabel id="underlying_disease2"value="จี-6-พีดี" control={<Checkbox/>} label="จี-6-พีดี "></FormControlLabel>
                <FormControlLabel id="underlying_disease3"value="โรคอ้วน" control={<Checkbox/>} label="โรคอ้วน"></FormControlLabel>
                <FormControlLabel value="โรคตับ" control={<Checkbox/>} label="โรคตับ"></FormControlLabel>
                <FormControlLabel value="โรคไต" control={<Checkbox/>} label="โรคไต"></FormControlLabel>
                <FormControlLabel value="โรคเบาหวาน" control={<Checkbox/>} label="โรคเบาหวาน"></FormControlLabel>
                <FormControlLabel value="โรคความดันโลหิตสูง" control={<Checkbox/>} label="โรคความดันโลหิตสูง"></FormControlLabel>
                <FormControlLabel value="อื่น ๆ" control={<Checkbox/>} label="อื่น ๆ"></FormControlLabel>
        ...
        <FormControl sx={{m:2}}>
            ...
            >
              ...
              <FormControlLabel sx={{ml:2}} value="ในประเทศไทย" control={<Radio/>} label="ในประเทศไทย" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ตาก" control={<Checkbox/>} label="ตาก" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="กาญจนบุรี" control={<Checkbox/>} label="กาญจนบุรี" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ตราด" control={<Checkbox/>} label="ตราด" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ราชบุรี" control={<Checkbox/>} label="ราชบุรี" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="แม่ฮ่องสอน" control={<Checkbox/>} label="แม่ฮ่องสอน" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ยะลา" control={<Checkbox/>} label="ยะลา" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ศรีสะเกษ" control={<Checkbox/>} label="ศรีสะเกษ" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="จันทบุรี" control={<Checkbox/>} label="จันทบุรี" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ประจวบคีรีขันธ์" control={<Checkbox/>} label="ประจวบคีรีขันธ์" ></FormControlLabel>

              <FormControlLabel sx={{ml:2}} value="ต่างประเทศ" control={<Radio/>} label="ต่างประเทศ" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ประเทศแถบแอฟริกา" control={<Checkbox/>} label="ประเทศแถบแอฟริกา" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ประเทศแถบหมู่เกาะแปซิฟิกตอนใต้" control={<Checkbox/>} label="ประเทศแถบหมู่เกาะแปซิฟิกตอนใต้" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ปาปัวนิวกินี" control={<Checkbox/>} label="ปาปัวนิวกินี" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="เมียนมาร์" control={<Checkbox/>} label="เมียนมาร์" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="ลาว" control={<Checkbox/>} label="ลาว" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="กัมพูชา" control={<Checkbox/>} label="กัมพูชา" ></FormControlLabel>
              <FormControlLabel sx={{ml:10}} value="มาเลเซีย" control={<Checkbox/>} label="มาเลเซีย" ></FormControlLabel>
        ...
        <FormControl sx={{m:2}}>
          ...
          <FormControl sx={{m:2}}>
            ...
            >
              <FormControlLabel value="รับประทานยาแล้วอาเจียน" control={<Checkbox />} label="รับประทานยาแล้วอาเจียน" />
              <FormControlLabel value="รับประทานยาซ้ำแล้วเกิดอาการอาเจียนอีกครั้งภายใน 1 ชั่วโมง" control={<Checkbox />} label="รับประทานยาซ้ำแล้วเกิดอาการอาเจียนอีกครั้งภายใน 1 ชั่วโมง" />
              <FormControlLabel value="ไม่สามารถรับประทานยาเม็ดได้" control={<Checkbox />} label="ไม่สามารถรับประทานยาเม็ดได้" />
        ...
        <FormControl sx={{m:2}}>
            ...
            >
              ...
              <FormControlLabel sx={{ml:2}} value="P. falciparum" control={<Checkbox/>} label="P. falciparum" ></FormControlLabel>
              <FormControlLabel sx={{ml:2}} value="P. vivax" control={<Checkbox/>} label="P. vivax" ></FormControlLabel>
              <FormControlLabel sx={{ml:2}} value="P. malariae" control={<Checkbox/>} label="P. malariae" ></FormControlLabel>
              <FormControlLabel sx={{ml:2}} value="P. ovale" control={<Checkbox/>} label="P. ovale" ></FormControlLabel>
              <FormControlLabel sx={{ml:2}} value="P. knowlesi" control={<Checkbox/>} label="P. knowlesi" ></FormControlLabel>
        ...
        <FormControl sx={{m:2}}>
            ...
            >
              <FormControlLabel value="ใช่" control={<Radio />} label="ใช่" />
              <FormControlLabel value="ไม่ใช่" control={<Radio />} label="0" />
            </RadioGroup>
          </FormControl>
          <br></br>
        ...
        <FormControl sx={{m:2}}>
          ...
          <FormControl sx={{m:2}}>
            ...
            >
              <FormControlLabel value="มีการหายใจมากกว่า 30 ครั้งต่อนาที" control={<Checkbox />} label="มีการหายใจมากกว่า 30 ครั้งต่อนาที" />
              <FormControlLabel value="มีค่า Oxygen Saturation น้อยกว่า 92%" control={<Checkbox />} label="มีค่า Oxygen Saturation น้อยกว่า 92%" />
              <FormControlLabel value="ไม่มีอาการดังกล่าว" control={<Radio />} label="ไม่มีอาการดังกล่าว" />
            </RadioGroup>
          </FormControl>
          <br></br>
          ...
          <FormControl sx={{m:2}}>
            ...
            >
              ...
              <FormControlLabel value="ไม่จำเป็น" control={<Radio />} label="0" />
            </RadioGroup>
          </FormControl>
          <br></br>
          <Button
