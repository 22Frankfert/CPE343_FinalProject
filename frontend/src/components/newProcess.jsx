...
function NewProcess({ handleDocRefChange }) {
  ...
  const [travelAbroadHistoryChecked, setTravelAbroadHistoryChecked] =
    useState(false);
  ...
  const addPatient = async (e) => {
    ...
    try {
      ...
      // const res = await axios.post("http://127.0.0.1:8000/api/case/rectest", { case_id: docRef.id }, { headers: { 'x-user-id': '"FQUM10nSOR525M0yLS95"', 'content-type': 'application/json', 'Access-Control-Allow-Origin':'*' } })
      const res = await axios.post(
        "http://127.0.0.1:8000/api/case/rectest",
        {
          case_id: customDocId,
        },
        {
      ...
      console.log(res);
      handleDocRefChange(customDocId);
    } catch (e) {
    ...
    <div className="App">
      ...
      <div className="App-info">
        ...
        />
            ...
            <FormControl sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="age">
                อายุ
                <dd>
                  หากอายุไม่ถึง 1 ปีให้ระบุเป็นเลขทศนิยม เช่น อายุ 5
                  เดือนโปรดระบุว่า อายุ 0.5 ปี
                </dd>
              </FormLabel>
              <TextField
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="gender">
                เพศ
              </FormLabel>
              <RadioGroup
              ...
              >
                ...
                {genderChecked && (
                  <div>
                    <FormControlLabel
                      sx={{ ml: 2, color: "black" }}
                      value="กำลังตั้งครรภ์หรือมีแผนในการมีลูก"
                      control={<Radio />}
                      label="กำลังตั้งครรภ์ หรือมีแผนในการมีลูก"
                    ></FormControlLabel>
                    <FormControlLabel
                      sx={{ ml: 2, color: "black" }}
                      value="ไม่ได้กำลังตั้งครรภ์แต่มีแผนในการมีลูก"
                      control={<Radio />}
                      label=" ไม่ได้กำลังตั้งครรภ์แต่มีแผนในการมีลูก"
                    ></FormControlLabel>
                    <FormControlLabel
                      sx={{ ml: 2, color: "black" }}
                      value="กำลังให้นมบุตร"
                      control={<Radio />}
                      label="กำลังให้นมบุตร"
                    ></FormControlLabel>
                  </div>
                )}
              </RadioGroup>
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="weight">
                น้ำหนัก
              </FormLabel>
              <TextField
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="temperature">
                อุณหภูมิร่างกาย
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
              ...
              >
                <FormControlLabel
                  sx={{ color: "black" }}
                  value="มากกว่า 39 องศา"
                  control={<Radio />}
                  label="มากกว่า 39 องศา"
                />
                <FormControlLabel
                  sx={{ color: "black" }}
                  value="น้อยกว่า 39 องศา"
                  control={<Radio />}
                  label="น้อยกว่า 39 องศา"
                />
              </RadioGroup>
            </FormControl>
            <br></br>
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="underlying_disease">
              ...
              >
                ...
                ></FormControlLabel>
                <FormControlLabel
                  checked={underlying_disease.includes(
                    "ภาวะพร่องเอ็นไซม์ G6PD"
                  )}
                  onChange={handleCheckboxChange}
                  value="ภาวะพร่องเอ็นไซม์ G6PD"
                  control={<Checkbox />}
                  label="ภาวะพร่องเอ็นไซม์ G6PD"
                ></FormControlLabel>
                ...
                <FormControlLabel
                  checked={underlying_disease.includes("โรคอ้วน")}
                  onChange={handleCheckboxChange}
                  value="โรคอ้วน"
                  control={<Checkbox />}
                  label="โรคอ้วน"
                ></FormControlLabel>
                <FormControlLabel
                  checked={underlying_disease.includes("โรคตับ")}
                  onChange={handleCheckboxChange}
                  value="โรคตับ"
                  control={<Checkbox />}
                  label="โรคตับ"
                ></FormControlLabel>
                <FormControlLabel
                  checked={underlying_disease.includes("โรคไต")}
                  onChange={handleCheckboxChange}
                  value="โรคไต"
                  control={<Checkbox />}
                  label="โรคไต"
                ></FormControlLabel>
                <FormControlLabel
                  checked={underlying_disease.includes("โรคเบาหวาน")}
                  onChange={handleCheckboxChange}
                  value="โรคเบาหวาน"
                  control={<Checkbox />}
                  label="โรคเบาหวาน"
                ></FormControlLabel>
                <FormControlLabel
                  checked={underlying_disease.includes("โรคความดันโลหิตสูง")}
                  onChange={handleCheckboxChange}
                ...
                <FormControlLabel
                  checked={underlying_disease.includes("อื่น ๆ")}
                  onChange={handleCheckboxChange}
                  value="อื่น ๆ"
                  control={<Checkbox />}
                  label="อื่น ๆ"
                  checked={otherDiseaseChecked}
                  onChange={handleCheckboxOtherDisease}
                ></FormControlLabel>
                {otherDiseaseChecked && (
                  <div>
                    <TextField
                      sx={{ ml: 4, bgcolor: "white" }}
                      label="โปรดระบุ"
                      variant="outlined"
                      onChange={(e) => setUnderlying_disease(e.target.value)}
                    ></TextField>
            ...
            <FormControl required sx={{ m: 2, minWidth: 300 }}>
              <FormLabel sx={{ color: "black" }} id="province">
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="travel_history">
                มีประวัติการเดินทางไปยังพื้นที่เสี่ยงอย่างน้อย 1
                เดือนที่ผ่านมาหรือไม่
              </FormLabel>
              <dd>
                พื้นที่เสี่ยงมาลาเรีย ได้แก่ ตาก กาญจนบุรี ราชบุรี แม่ฮ่องสอน
                ยะลา ศรีสะเกษ ประจวบคีรีขันธ์ ชุมพร เพชรบุรี ระนอง สงขลา
                อุบลราชธานี
              </dd>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
...
{isChecked && (
        <div> */}
                ...
                <FormControlLabel
                  checked={travel_history.includes("ในประเทศไทย")}
                ...
                {travelHistoryChecked && (
                  <div>
                    <FormControlLabel
                      checked={travel_history.includes("ตาก")}
                      onChange={handleTravelHistoryChange}
                      value="ตาก"
                      control={<Checkbox />}
                      label="ตาก"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("กาญจนบุรี")}
                      onChange={handleTravelHistoryChange}
                      value="กาญจนบุรี"
                      control={<Checkbox />}
                      label="กาญจนบุรี"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("ตราด")}
                      onChange={handleTravelHistoryChange}
                      value="ตราด"
                      control={<Checkbox />}
                      label="ตราด"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("ราชบุรี")}
                      onChange={handleTravelHistoryChange}
                      value="ราชบุรี"
                      control={<Checkbox />}
                      label="ราชบุรี"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("แม่ฮ่องสอน")}
                      onChange={handleTravelHistoryChange}
                      value="แม่ฮ่องสอน"
                      control={<Checkbox />}
                      label="แม่ฮ่องสอน"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("ยะลา")}
                      onChange={handleTravelHistoryChange}
                      value="ยะลา"
                      control={<Checkbox />}
                      label="ยะลา"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("ศรีสะเกษ")}
                      onChange={handleTravelHistoryChange}
                      value="ศรีสะเกษ"
                      control={<Checkbox />}
                      label="ศรีสะเกษ"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("จันทบุรี")}
                      onChange={handleTravelHistoryChange}
                      value="จันทบุรี"
                      control={<Checkbox />}
                      label="จันทบุรี"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("ประจวบคีรีขันธ์")}
                      onChange={handleTravelHistoryChange}
                ...
                <FormControlLabel
                  checked={travel_history.includes("ต่างประเทศ")}
                  onChange={handleTravelHistoryChange}
                  value="ต่างประเทศ"
                  control={<Checkbox />}
                  label="ต่างประเทศ"
                ...
                {travelAbroadHistoryChecked && (
                  <div>
                    <FormControlLabel
                      checked={travel_history.includes("ประเทศแถบแอฟริกา")}
                      onChange={handleTravelHistoryChange}
                      value="ประเทศแถบแอฟริกา"
                      control={<Checkbox />}
                      label="ประเทศแถบแอฟริกา"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes(
                        "ประเทศแถบหมู่เกาะแปซิฟิกตอนใต้"
                      )}
                      onChange={handleTravelHistoryChange}
                      value="ประเทศแถบหมู่เกาะแปซิฟิกตอนใต้"
                      control={<Checkbox />}
                      label="ประเทศแถบหมู่เกาะแปซิฟิกตอนใต้"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("ปาปัวนิวกินี")}
                      onChange={handleTravelHistoryChange}
                      value="ปาปัวนิวกินี"
                      control={<Checkbox />}
                      label="ปาปัวนิวกินี"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("เมียนมาร์")}
                      onChange={handleTravelHistoryChange}
                      value="เมียนมาร์"
                      control={<Checkbox />}
                      label="เมียนมาร์"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("ลาว")}
                      onChange={handleTravelHistoryChange}
                      value="ลาว"
                      control={<Checkbox />}
                      label="ลาว"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("กัมพูชา")}
                      onChange={handleTravelHistoryChange}
                      value="กัมพูชา"
                      control={<Checkbox />}
                      label="กัมพูชา"
                    ></FormControlLabel>
                    <FormControlLabel
                      checked={travel_history.includes("มาเลเซีย")}
                      onChange={handleTravelHistoryChange}
                      value="มาเลเซีย"
                      control={<Checkbox />}
                      label="มาเลเซีย"
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="drug_allergy">
                มีประวัติการแพ้ยาต้านมาลาเรียหรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
                defaultValue="yes"
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="taking_medicine">
                อาการหลังจากรับประทานยาเม็ดของผู้ป่วย
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
                defaultValue="yes"
              ...
              >
                <FormControlLabel
                  checked={taking_medicine.includes("รับประทานยาแล้วอาเจียน")}
                  onChange={handleTakingMedicineChange}
                  value="รับประทานยาแล้วอาเจียน"
                  control={<Checkbox />}
                  label="รับประทานยาแล้วอาเจียน"
                />
                <FormControlLabel
                  checked={taking_medicine.includes(
                    "รับประทานยาซ้ำแล้วเกิดอาการอาเจียนอีกครั้งภายใน 1 ชั่วโมง"
                  )}
                  onChange={handleTakingMedicineChange}
                  value="รับประทานยาซ้ำแล้วเกิดอาการอาเจียนอีกครั้งภายใน 1 ชั่วโมง"
                  control={<Checkbox />}
                  label="รับประทานยาซ้ำแล้วเกิดอาการอาเจียนอีกครั้งภายใน 1 ชั่วโมง"
                />
                <FormControlLabel
                  checked={taking_medicine.includes(
                    "ไม่สามารถรับประทานยาเม็ดได้"
                  )}
                  onChange={handleTakingMedicineChange}
                  value="ไม่สามารถรับประทานยาเม็ดได้"
                  control={<Checkbox />}
                  label="ไม่สามารถรับประทานยาเม็ดได้"
                />
                <FormControlLabel
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="malaria_history">
                ประวัติการติดเชื้อมาลาเรียในช่วง 1 ปีที่ผ่านมา
                และโปรดระบุสปีชีส์ที่ติด
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
                defaultValue="yes"
                ...
                {malariaHistoryChecked && (
                  <div>
                    <FormControlLabel
                      ...
                      checked={malaria_history.includes("P. falciparum")}
                      onChange={handleMalariaHistoryChange}
                      value="falciparum"
                      control={<Checkbox />}
                      label="P. falciparum"
                    ></FormControlLabel>
                    <FormControlLabel
                      sx={{ ml: 2, fontStyle: "italic" }}
                      checked={malaria_history.includes("P. vivax")}
                      onChange={handleMalariaHistoryChange}
                      value="vivax"
                      control={<Checkbox />}
                      label="P. vivax"
                    ...
                    <FormControlLabel
                      sx={{ ml: 2, fontStyle: "italic" }}
                      checked={malaria_history.includes("P. malariae")}
                      onChange={handleMalariaHistoryChange}
                      value="malariae"
                      control={<Checkbox />}
                      label="P. malariae"
                    ...
                    <FormControlLabel
                      sx={{ ml: 2, fontStyle: "italic" }}
                      checked={malaria_history.includes("P. ovale")}
                      onChange={handleMalariaHistoryChange}
                      value="ovale"
                      control={<Checkbox />}
                      label="P. ovale"
                    ...
                    <FormControlLabel
                      sx={{ ml: 2, fontStyle: "italic" }}
                      checked={malaria_history.includes("P. knowlesi")}
                      onChange={handleMalariaHistoryChange}
                      value="knowlesi"
                      control={<Checkbox />}
                      label="P. knowlesi"
                    ...
                    <FormControlLabel
                      sx={{ ml: 2 }}
                      value="ไม่ทราบสปีชีส์ที่ติด"
                      control={<Radio />}
                      label="ไม่ทราบสปีชีส์ที่ติด"
                    ></FormControlLabel>
                  </div>
                )}
                <FormControlLabel
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="urine_amount">
                ปัสสาวะน้อยหรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
              ...
              >
                <FormControlLabel
                  value="ไม่มีปัสสาวะภายใน 4 ชั่วโมง"
                  control={<Radio />}
                  label="ไม่มีปัสสาวะภายใน 4 ชั่วโมง"
                />
                <FormControlLabel
                  value="ปัสสาวะออกน้อยกว่า 400 ml/วัน"
                  control={<Radio />}
                  label="ปัสสาวะออกน้อยกว่า 400 ml/วัน"
                />
                <FormControlLabel
                  value="ไม่มีอาการดังกล่าว"
                  control={<Radio />}
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="urine_color">
                ปัสสาวะสีเข้มหรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
                defaultValue="yes"
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="convulsions">
                มีอาการชักหรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="comatose">
                ผู้ป่วยไม่มีสติหรือหมดสติหรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
                defaultValue="yes"
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="bleeding">
                พบเลือดออกผิดปกติหรือไม่
                <dd>เช่น เหงือก จมูก อาเจียนหรือถ่ายเป็นเลือด</dd>
              </FormLabel>
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="fatigue">
                มีอาการอ่อนเพลีย ไม่สามารถนั่ง เดิน หรือยืนเองได้หรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
                defaultValue="yes"
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="asthma">
                พบอาการหอบหรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
              ...
              >
                <FormControlLabel
                  checked={asthma.includes("มีการหายใจมากกว่า 30 ครั้งต่อนาที")}
                  onChange={handleAsthmaChange}
                  value="มีการหายใจมากกว่า 30 ครั้งต่อนาที"
                  control={<Checkbox />}
                  label="มีการหายใจมากกว่า 30 ครั้งต่อนาที"
                />
                <FormControlLabel
                  checked={asthma.includes(
                    "มีค่า Oxygen Saturation น้อยกว่า 92%"
                  )}
                  onChange={handleAsthmaChange}
                  value="มีค่า Oxygen Saturation น้อยกว่า 92%"
                  control={<Checkbox />}
                  label="มีค่า Oxygen Saturation น้อยกว่า 92%"
                />
                <FormControlLabel
                  value="ไม่มีอาการดังกล่าว"
                  control={<Radio />}
            ...
            <FormControl required sx={{ m: 2 }}>
              <FormLabel sx={{ color: "black" }} id="refer">
                จำเป็นต้องมีการส่งต่อผู้ป่วยไปยังโรงพยาบาลอื่นหรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
                defaultValue="yes"
          ...
          >
            ...
            <FormControl required sx={{ m: 2, position: "center" }}>
              <FormLabel sx={{ color: "black" }} id="anemia">
                พบภาวะซีดหรือไม่
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
            ...
            <FormControl required sx={{ m: 2 }}>
              ...
              >
                <FormControlLabel
                  checked={kidney_failure.includes(
                    "มีค่า Blood Urea Nitrogen(BUN) มากกว่า 20 mmol/L"
                  )}
                  onChange={handleKidneyFailureChange}
                ...
                <FormControlLabel
                  checked={kidney_failure.includes(
                    "มีค่า Creatinine มากกว่า 265 µmol/L (3 mg/dL)"
                  )}
                  onChange={handleKidneyFailureChange}
            ...
            <FormControl required sx={{ m: 2 }}>
              ...
              >
                <FormControlLabel
                  sx={{ fontStyle: "italic" }}
                  checked={malaria_type.includes("P. falciparum")}
                  onChange={handleMalariaTypeChange}
                  value="falciparum"
                  control={<Checkbox />}
                  label="P. falciparum"
                />
                <FormControlLabel
                  sx={{ fontStyle: "italic" }}
                  checked={malaria_type.includes("P. vivax")}
                  onChange={handleMalariaTypeChange}
                  value="vivax"
                  control={<Checkbox />}
                  label="P. vivax"
                ...
                <FormControlLabel
                  sx={{ fontStyle: "italic" }}
                  checked={malaria_type.includes("P. malariae")}
                  onChange={handleMalariaTypeChange}
                  value="malariae"
                  control={<Checkbox />}
                  label="P. malariae"
                ...
                <FormControlLabel
                  sx={{ fontStyle: "italic" }}
                  checked={malaria_type.includes("P. ovale")}
                  onChange={handleMalariaTypeChange}
                  value="ovale"
                  control={<Checkbox />}
                  label="P. ovale"
                ...
                <FormControlLabel
                  sx={{ fontStyle: "italic" }}
                  checked={malaria_type.includes("P. knowlesi")}
                  onChange={handleMalariaTypeChange}
                  value="knowlesi"
                  control={<Checkbox />}
                  label="P. knowlesi"
            ...
            <FormControl required sx={{ m: 2 }}>
              ...
              >
                <FormControlLabel
                  checked={malaria_amount.includes(
                    "มากกว่า 1,250 ตัวต่อเม็ดเลือดขาว 100 ตัว"
                  )}
                  onChange={handleMalariaAmountChange}
                ...
                <FormControlLabel
                  checked={malaria_amount.includes(
                    "มากกว่า 100,000/µl ในกรณีที่ตรวจด้วยฟิล์มเลือดหนา"
                  )}
                  onChange={handleMalariaAmountChange}
                ...
                />
                <FormControlLabel
                  checked={malaria_amount.includes("พบเชื้อระยะแบ่งตัว")}
                  onChange={handleMalariaAmountChange}
            ...
            <FormControl required sx={{ m: 2 }}>
              ...
              >
                <FormControlLabel
                  checked={acidosis.includes(
                    "ระดับแลคเตทมากกว่าหรือเท่ากับ 5 mmol/L"
                  )}
                  onChange={handleAcidosisChange}
                ...
                <FormControlLabel
                  checked={acidosis.includes(
                    "ระดับ Bicarbonate น้อยกว่า 15 mmol/L"
                  )}
                  onChange={handleAcidosisChange}
            ...
            <FormControl required sx={{ m: 2 }}>
              ...
              >
                <FormControlLabel value="พบ" control={<Radio />} label="พบ" />

                <FormControlLabel
                  sx={{ ml: 2 }}
                  checked={pulmonary_edema.includes("จากการฟัง")}
                  onChange={handlePulmonaryEdemaChange}
                  value="จากการฟัง"
                  control={<Checkbox />}
                  label="จากการฟัง"
                ></FormControlLabel>
                <FormControlLabel
                  sx={{ ml: 2 }}
                  checked={pulmonary_edema.includes("จากการ X-Ray")}
                  onChange={handlePulmonaryEdemaChange}
                  value="จากการ X-Ray"
                  control={<Checkbox />}
                  label="จากการ X-Ray"
                ...
                <FormControlLabel value="0" control={<Radio />} label="ไม่พบ" />
              </RadioGroup>
            </FormControl>
