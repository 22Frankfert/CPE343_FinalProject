...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    // {role.D}:"แพทย์",
    // {role.N}:"พยาบาล",
    // {role.T}:"นักเทคนิคการแพทย์",
    // {role.O}:"เจ้าพนักงานสาธารณสุข",
    // {role.S}:"ผู้เชี่ยวชาญด้านมาลาเรีย"
  }, [user, loading]);
  const displayRole = () => {
    switch (role) {
      case "D":
...
<div style={{ marginRight: "30px" }}>
          <Avatar
            variant="rounded"
            sx={{ backgroundColor:"#785e56",width: "300px", height: "300px",borderRadius: "50%", fontSize:50 }}
            // src={image}
        ...
        {/* </Column1> */}
          ...
          {/* <TextField sx={{m:2}} id="outlined-read-only-input" defaultValue="ชื่อ-นามสกุล" InputProps={{eadOnly: true }}> */}
            <Grid sx={{m:2,p:4, backgroundColor:"white", borderRadius:2}}>
          ...
          <Button sx={{bgcolor:"#CE3A50"}} variant="contained" onClick={logout}  >ออกจากระบบ</Button>
        {/* </Box> */}
        </Grid>
        </div>
      </div>
